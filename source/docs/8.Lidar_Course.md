...
To access the detailed instructions about the app connection, please refer to the file locating in [2. Quick User Experience->2.1 App Installation & Connection]().
...
<img src="../_static/media/chapter_8/section_3/media/image5.jpeg" class="common_img" />

### 8.3.3 Enable Lidar Games Through Command

(1) Start the ROSPug robot dog and access the robot system desktop using NoMachine.

(2) Click on <img src="../_static/media/chapter_8/section_3/media/image6.png" /> to open the command line terminal.
...
The source code for this program can be found at: [/home/hiwonder/pug/src/pug_app/scripts/lidar_app.py]()
...
<img src="../_static/media/chapter_8/section_4/media/image3.png" class="common_img" />

*   **Lidar Following**

(1) Activate **‘Lidar following’** button to start the game.

<img src="../_static/media/chapter_8/section_4/media/image4.png" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_8/section_4/media/image6.png" /> to start the command-line terminal.
...
The source code for this program is located at [/home/hiwonder/pug/src/pug_app/scripts/lidar_app.py]().
...
<img src="../_static/media/chapter_8/section_4/media/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_8/section_5/media/image3.png" class="common_img" />

*   **Lidar Guarding**

(1) Activate the Lidar Guarding icon to start the game.

<img src="../_static/media/chapter_8/section_5/media/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_8/section_5/media/image5.jpeg" class="common_img" />

<img src="../_static/media/chapter_8/section_5/media/image6.jpeg" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_8/section_5/media/image7.png" /> to start the command-line terminal.
...
<img src="../_static/media/chapter_8/section_5/media/image11.png" class="common_img" />
...
(2) Double-click <img src="../_static/media/chapter_8/section_6/media/image2.png" /> to open the command-line terminal.
...
<img src="../_static/media/chapter_8/section_6/media/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_8/section_6/media/image8.png" class="common_img" />

(7) Select **‘odom’** as imu’s reference coordinate system.

<img src="../_static/media/chapter_8/section_6/media/image9.png" class="common_img" />

(8) Add Odometry display option according to the picture.

<img src="../_static/media/chapter_8/section_6/media/image10.png" class="common_img" />

(9) Select the topic **‘/odom_rf2o’** to view the Lidar simulated odometer.

<img src="../_static/media/chapter_8/section_6/media/image11.png" class="common_img" />
