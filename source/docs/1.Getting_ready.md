...
| ---- | ----------------------------- | -------- | ------------------------------------------------------------ |
| 1    | ROSPug                        | 1        | <img src="../_static/media/chapter_1/section_1/02/1.png" width="500px"/> |
| 2    | WIFI antennas                 | 2        | <img src="../_static/media/chapter_1/section_1/02/2.png" />  |
| 3    | 12.6V 2A charger(DC 4.0*1.7m) | 1        | <img src="../_static/media/chapter_1/section_1/02/3.png" width="300px" /> |
| 4    | Card reader                   | 1        | <img src="../_static/media/chapter_1/section_1/02/4.png" width="100px"/> |
| 5    | Wireless handle               | 1        | <img src="../_static/media/chapter_1/section_1/02/5.png" width="300px" /> |
| 6    | 6.3cm Purple ball             | 1        | <img src="../_static/media/chapter_1/section_1/02/6.png" />  |
| 7    | Screwdiwer                    | 1        | <img src="../_static/media/chapter_1/section_1/02/7.png" width="200px"/> |
| 8    | Accessory bag                 |          | <img src="../_static/media/chapter_1/section_1/02/8.png" />  |
| 9    | User manual                   | 1        | <img src="../_static/media/chapter_1/section_1/02/9.jpg" width="500px"/> |
...
① To ensure stable performance, recharge the battery if its level falls below 10V before proceeding with operation. For detailed charging instructions, refer to [1. Getting Ready->1.3 Startup Preparation]() .
