...
<img src="../_static/media/chapter_10/section_2/02/image1.png" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_10/section_2/02/image2.png"  /> to open the command-line terminal.
...
The source code is saved in: [/home/pug/src/pug_example/scripts/machine_learning/hand_detect.py](../_static/source_code/machine_learning.zip)
...
(2) Double-click <img src="../_static/media/chapter_10/section_2/03/image2.png"  /> to open the command-line terminal.
...
|:--:|:--:|:--:|
| ok | <img src="../_static/media/chapter_10/section_2/03/image5.png"/> | Rotate around roll-axis (roll_turn) |
| fist | <img src="../_static/media/chapter_10/section_2/03/image6.png"/> | Push-up（push-up） |

* **Code Analysis**

The source code is saved in: [/home/pug/src/pug_example/scripts/machine_learning/gesture_control.py](../_static/source_code/machine_learning.zip)
...
(2) Double-click <img src="../_static/media/chapter_10/section_3/02/image2.png" /> to open the command-line terminal.
...
The source code is saved in: [/home/pug/src/pug_example/scripts/machine_learning/finger_track.py](../_static/source_code/machine_learning.zip)

<img src="../_static/media/chapter_10/section_3/02/image4.png" class="common_img" />
...
The source code is saved in: [/home/pug/src/pug_example/scripts/machine_learning/pose_control.py](../_static/source_code/machine_learning.zip)

<img src="../_static/media/chapter_10/section_3/02/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image2.png" class="common_img" />

<img src="../_static/media/chapter_10/section_4/01/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image11.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image13.png" class="common_img" />

<img src="../_static/media/chapter_10/section_4/01/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image16.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image17.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/01/image18.png" class="common_img" />

Below is the output structures of data of three sizes.

<img src="../_static/media/chapter_10/section_4/01/image19.png" class="common_img" />

<img src="../_static/media/chapter_10/section_4/01/image20.png" class="common_img" />

<img src="../_static/media/chapter_10/section_4/01/image21.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_4/02/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image5.png" class="common_img" />

② Click-on **'Select'** button, then choose **'/home/hiwonder/My_Data/JPEGImages'** and click-on **'Open'** to save pictures.

<img src="../_static/media/chapter_10/section_5/01/image6.png" class="common_img" />

<img src="../_static/media/chapter_10/section_5/01/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image9.png" class="common_img" />

Upon launching the image annotation tool, the table below outlines the key functions.

| **Icon** | **Shortcut Key** | **Function** |
|:--:|:--:|:--:|
| <img src="../_static/media/chapter_10/section_5/01/image10.png" class="common_img" /> | Ctrl+U | Select the directory where the picture is saved. |
| <img src="../_static/media/chapter_10/section_5/01/image11.png" class="common_img" /> | Ctrl+R | Select the directory where the calibration data is saved. |
| <img src="../_static/media/chapter_10/section_5/01/image12.png" class="common_img" /> | W | Create annotation box |
| <img src="../_static/media/chapter_10/section_5/01/image13.png" class="common_img" /> | Ctrl+S | Save annotation |
| <img src="../_static/media/chapter_10/section_5/01/image14.png" class="common_img" /> | A | Switch to the previous image |
| <img src="../_static/media/chapter_10/section_5/01/image15.png" class="common_img" /> | D | Switch to the next image |
...
<img src="../_static/media/chapter_10/section_5/01/image16.png" class="common_img" />
<img src="../_static/media/chapter_10/section_5/01/image17.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image18.png" class="common_img" />
<img src="../_static/media/chapter_10/section_5/01/image19.png" class="common_img" />

④ Click-on **'Create RectBox'** button to create a annotation box.

<img src="../_static/media/chapter_10/section_5/01/image20.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image21.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image22.png" class="common_img" />

⑦ After labeling a picture, click-on **'Save'** button, then click-on **'Next Image'** to proceed with the image labeling.

<img src="../_static/media/chapter_10/section_5/01/image23.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/01/image24.png" class="common_img" />
...
Before proceeding with this section, ensure that image collection and annotation have been completed. For detailed operational steps, please refer to the documents located in the [10.5.1 Image Collecting and Labeling](#anchor_10_5_1) directory.
...
(2) Click-on <img src="../_static/media/chapter_10/section_5/02/image2.png"   /> to launch the command-line terminal.
...
<img src="../_static/media/chapter_10/section_5/02/image7.png" class="common_img" />

Modify the selected path to the correct location where your system files are stored.

<img src="../_static/media/chapter_10/section_5/02/image8.png" class="common_img" />

If the message shown in the image below appears, the conversion has been successful.

<img src="../_static/media/chapter_10/section_5/02/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/03/image2.png" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_10/section_5/02/image2.png" /> to initiate the command-line terminal.
...
<img src="../_static/media/chapter_10/section_5/03/image7.png" class="common_img" />

If the content shown in the image below appears, it means that training is currently in progress.

<img src="../_static/media/chapter_10/section_5/03/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_5/03/image9.png" class="common_img" />

<img src="../_static/media/chapter_10/section_5/03/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_6/image2.png" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_10/section_7/image2.png" /> to open the command-line terminal.
...
<img src="../_static/media/chapter_10/section_7/image13.png" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_10/section_7/image15.png"  /> to navigate to the file manager and locate the following folder.

<img src="../_static/media/chapter_10/section_7/image16.png" class="common_img" />

(3) Right-click the file **'yolo5v_trt.py'**, and choose **'Open With Text Editor'**.

<img src="../_static/media/chapter_10/section_7/image17.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_7/image18.png" class="common_img" />

(5) Click-on **'Save'** button to save the modification.

<img src="../_static/media/chapter_10/section_7/image19.png" class="common_img" />
...
<img src="../_static/media/chapter_10/section_7/image22.png" class="common_img" />

<img src="../_static/media/chapter_10/section_7/image23.png" class="common_img" />
