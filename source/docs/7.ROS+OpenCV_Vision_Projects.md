...
(2) Double-click <img src="../_static/media/chapter_7/section_1/media/image2.png" /> to start the `LabConfig` tool. If the software is enabled successfully, you can skip step (3) to (6).

(3) If `LabConfig` cannot be opened, double-click <img src="../_static/media/chapter_7/section_1/media/image3.png" /> to open the command-line terminal.
...
(6) Double-click <img src="../_static/media/chapter_7/section_1/media/image2.png" /> to open the `LabConfig` tool.
...
| **Icon**                                                              | **Function**                                                                                                            |
| :--------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------: |
| <img src="../_static/media/chapter_7/section_1/media/image7.png" /> | Drag the sliders L, A and B to adjust the L, A and B components of the live camera feed.                                |
| <img src="../_static/media/chapter_7/section_1/media/image8.png" /> | Select the color to be adjusted.                                                                                        |
| <img src="../_static/media/chapter_7/section_1/media/image9.png" /> | Apply the color threshold currently adjusted.                                                                           |
| <img src="../_static/media/chapter_7/section_1/media/image10.png" /> | Save the adjustment result.                                                                                             |
| <img src="../_static/media/chapter_7/section_1/media/image11.png" /> | Add new colors to be recognized.                                                                                        |
...
<img src="../_static/media/chapter_7/section_1/media/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_1/media/image16.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_1/media/image18.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_1/media/image20.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_1/media/image21.png" class="common_img" />

(5) Click-on **'Save'** button to save the the currently adjusted color threshold parameters.

<img src="../_static/media/chapter_7/section_1/media/image22.png" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_7/section_2/media/image3.png" /> to open the command-line terminal.
...
(2) Click-on <img src="../_static/media/chapter_7/section_3/media/image2.png" /> to open the command-line terminal.
...
Utilize the `ColorTrackingNode` class to track one of the colors, namely red, green, or blue. For detailed analysis of the `ColorTrackingNode` class, please refer to [Sub-function Analysis]() section.
...
(2) Double-click <img src="../_static/media/chapter_7/section_4/media/image2.png" /> to open the command-line terminal.
...
(2) <img src="../_static/media/chapter_7/section_5/media/image3.png" /> Double-click to open the command-line terminal.
...
(2) <img src="../_static/media/chapter_7/section_6/media/image3.png" /> Double-click to open the command-line terminal.
